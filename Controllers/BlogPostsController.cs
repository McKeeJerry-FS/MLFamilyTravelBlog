...
using MLFamilyTravelBlog.Helpers;
...
namespace MLFamilyTravelBlog.Controllers
{
    public class BlogPostsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? categoryId, int? pageNum)
        {
            ...
            {
                // normal operation
                blogPosts = (await _blogService.GetBlogPostsAsync()).ToPagedList(page, pageSize);

            }
            else
            {
                // filtered by category
                blogPosts = (await _blogService.FilterBlogPostByCategory(categoryId)).ToPagedList(page, pageSize);
            }
        ...
        public async Task<IActionResult> Popular(int? pageNum)
        {
            ...
            popularBlogs = (await _blogService.GetPopularBlogsAsync()).ToPagedList(page, pageSize);
        ...
        public async Task<IActionResult> Favorites(int? pageNum)
        {
            ...
            if (user != null)
            {
                favoriteBlogs = (await _blogService.GetFavoriteBlogPostsAsync(user!.Id)).ToPagedList(page, pageSize);
        ...
        public async Task<IActionResult> SearchIndex(string? searchString, int? pageNum)
        {
            ...
            var blogPostsEnumerable = _blogService.SearchBlogPost(searchString);
        ...
        public async Task<IActionResult> AuthorArea(int? pageNum)
        {
            ...
            IPagedList<BlogPost> blogPosts = (await _blogService.GetAllBlogPostsAsync())
